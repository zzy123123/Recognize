...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		praiseRatio = a.getFloat(
				R.styleable.roundedimageview_praise_ratio, 100);
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		}/*else if(drawable instanceof RoundedBitmapDisplayer.RoundedDrawable){
			b = Bitmap
					.createBitmap(
							getWidth(),
							getHeight(),
	...
	private void drawCircleBorder(Canvas canvas, int radius, int color) {
		...
		RectF rect = new RectF(mBorderThickness,mBorderThickness,defaultWidth-mBorderThickness,
				defaultHeight-mBorderThickness);
		canvas.drawArc(rect, 0, 360*praiseRatio, false, paint);
